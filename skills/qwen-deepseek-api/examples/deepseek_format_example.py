...
BATCH_DIR = ROOT / "_tmp" / "ds_batches"
...
EXAMPLES_30 = (ROOT / "_tmp" / "examples_30.txt").read_text().strip()
...
def main():
    rows = list(csv.DictReader((ROOT / "high_freq_surface.csv").open()))[:1250]
    examples = json.loads((ROOT / "_tmp" / "examples.json").read_text())
