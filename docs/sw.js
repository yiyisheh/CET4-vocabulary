...
var PRECACHE = ["./index.html", "./manifest.webmanifest", "./icon-180.png", "./icon-192.png", "./icon-512.png", "./synbook.html"];
var KEEP = ["./index.html", "./manifest.webmanifest", "./icon-180.png", "./icon-192.png", "./icon-512.png", "./synbook.html", "./audio-us.9f9a204cb2.bin", "./audio-ex.7b5586bace.bin"];
var APP = "./index.html";
